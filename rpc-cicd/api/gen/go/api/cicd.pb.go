...
type Job struct {
	...
	ExitCode string `protobuf:"bytes,4,opt,name=exitCode,proto3" json:"exitCode,omitempty" bson:"exitCode,omitempty"`
	Stdout   string `protobuf:"bytes,5,opt,name=stdout,proto3" json:"stdout,omitempty" bson:"stdout,omitempty"`
	Stderr   string `protobuf:"bytes,6,opt,name=stderr,proto3" json:"stderr,omitempty" bson:"stderr,omitempty"`
}
...
var fileDescriptor_7a38a6ec253b08d3 = []byte{
	...
	,
}
